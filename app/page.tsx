  ...
  return (
    <div>
      ...
      <div className="fixed bottom-2 md:bottom-1 m-auto right-0 md:right-72 left-0 md:left-auto flex justify-center items-center gap-2 w-36  md:w-auto">
        <a title="Link Github" href="https://inatews.git bmkg.go.id" className='flex gap-1 text-center justify-center  m-auto'>
          <div className='bmkg-icon'></div>
          <span>BMKG</span>
        </a>
        <a title="Link Github" href="https://github.com/iRust7/IMK-EWSNHL" className='flex gap-1 text-center justify-center  m-auto'>
      ...
      <div className='fixed m-auto top-0 bottom-0 left-0 right-0 flex flex-col justify-center items-center overlay-bg text-center' id='loading-screen'>
        ...
        <p className='my-2 red-color p-2'>INI MERUPAKAN DESAIN KONSEP - EWS UNTUK KEPERLUAN TUGAS IMK</p>
      </div>
